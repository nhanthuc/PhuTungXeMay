...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
 ...
 <table class="table animated wow fadeInLeft" data-wow-delay=".5s">
		  ...
		  <tr class="cross1">
			<td class="t-data">
				<a href="single.jsp?productID=" class="at-in">
                                  <img src="" class="fashion-grid" alt=""> 
			...
			<td class="t-data"> VNĐ</td>
			<td class="t-data"><div class="quantity"> 
								<div class="quantity-select">            
									<div class="entry value-minus">&nbsp;</div>
										<div class="entry value"><span class="span-1"></span></div>									
                        ...
                        <td class="t-data"><a href="CartServlet?command=remove&productID="><img src="images/circle.png" class="img-responsive " alt=""></a></td>
			 ...
			 <ul class="total_price">
			   ...
			   <li class="last_price"><span> VNĐ</span></li>
			   <div class="clearfix"> </div>
			 </ul>
