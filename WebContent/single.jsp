				...
				<div class="categories animated wow fadeInUp animated"
					...
					<ul class="cate">
						...
						<li><i class="glyphicon glyphicon-menu-right"></i><a
							href="products.jsp?category="></a></li>
					...
					<div class="product-head">
						...
						<div class="product-go">
							<div class=" fashion-grid">
								<a href="single.jsp?productID=>"><img
							...
							<div class=" fashion-grid1">
								<h6 class="best2">
									<a href="single.jsp?productID="></a>
								</h6>
								<span class=" price-in1">
									VNĐ</span>
								<p>
									<a
										href="CartServlet?command=plus&productID="
				...
				<div class="col-md-7 single-top-in">
					<div class="span_2_of_a1 simpleCart_shelfItem">
						...
						<div class="price_single">
							...
							<br> <span class="reducedfrom item_price">
								VNĐ</span> <a
								href="CartServlet?command=plus&productID="
								data-text="Thêm vào giỏ" class="but-hover1 item_add">Thêm
								vào giỏ</a>
							...
							<div class="resp-tabs-container">
								...
								<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
									<div class="comments-top-top">
										...
										<a class="add-re"
											href="review.jsp?command=insert&product_id="><i
